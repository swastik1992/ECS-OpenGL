...
PostProcessing::PostProcessing(Shader* _shader, GLint _width, GLint _height)
	:postProcessingShader(_shader), width(_width), height(_height), Shake(GL_FALSE), Blur(GL_FALSE)
{
